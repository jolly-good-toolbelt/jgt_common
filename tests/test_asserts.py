...
def test_is_in_asserts():
    ...
    assert_.is_in('me', dict(do='a deer', re='A drop of golden sun', me='a name I call myself'))
    with pytest.raises(AssertionError):
...
def test_not_in_asserts():
    ...
    assert_.not_in('fa', dict(do='a deer', re='A drop of golden sun', me='a name I call myself'))
    with pytest.raises(AssertionError):
